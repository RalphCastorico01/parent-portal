...
<body>
    ...
    <div class="container mt-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="profile_page5.php" method="POST">

                    <div class="row">
                         <div class="form-group col-md-6">
                            <label>Pumapasok ba sa paaralan ang iyong anak?</label><br>
                            <input type="radio" id="Oo" name="ina_chec" value="Oo" required>
                            <label for="Oo">Oo</label><br>
                            <input type="radio" id="Hindi" name="ina_check" value="Hindi" required>
        ...
        <div class="container mt-3 text-center">
            <a href="profile_page4.php" class="btn btn-secondary">← Back to Page 4</a>
            <button type="submit" class="btn btn-primary">I-save ang Impormasyon</button>
            <a href="profile_page6.php" class="btn btn-secondary">Next Page 6</a>
        </div>
    </div>
